...
import TodoApp from '../src/js/TodoApp.jsx';
import Container from '../src/js/Container.jsx';
import TodoHeader from '../src/js/TodoHeader.jsx';
import TodoItems from '../src/js/TodoItems.jsx';
import TodoItem from '../src/js/TodoItem.jsx';
import TodoFooter from '../src/js/TodoFooter.jsx';
import TodoModel from '../src/js/TodoModel.js';
...
describe('TodoMVC App', function() {
  ...
  describe('UI bindings', function() {
    ...
    it('allows the user to check active items', function() {
      ...
      // when
      todoItem.render().find('.toggle').trigger('change', {
        'target': {
          'checked': true
        }
      });
    ...
    it('allows the user to mark all items as completed', function() {
      ...
      // when
      todoItems.render().find('.toggle-all').trigger('change', {
        'target': {
          'checked': true
        }
      });
